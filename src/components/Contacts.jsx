...
function Contacts() {
  return (
    <section id="contact" className="min-h-screen bg-[#240000]">
      {" "}
      <div className="container-main flex min-h-screen flex-col items-center justify-center px-6 py-20">
        {" "}
        {/* Heading */}{" "}
        ...
        <div className="grid w-full max-w-5xl grid-cols-1 gap-8 lg:grid-cols-2">
          {" "}
          {/* Contact Information */}{" "}
          <div className="rounded-2xl border border-[#E69A00]/20 bg-[#300000] p-8">
            {" "}
          ...
          {/* Contact Form */}{" "}
          <form className="rounded-2xl border border-[#E69A00]/20 bg-[#300000] p-8">
            {" "}
            <div>
              {" "}
              ...
              <input
                ...
                className="mt-2 w-full rounded-lg border border-white/10 bg-[#240000] px-4 py-3 text-white outline-none transition focus:border-[#E69A00]"
              />{" "}
            </div>{" "}
            <div className="mt-5">
              {" "}
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                className="mt-2 w-full resize-none rounded-lg border border-white/10 bg-[#240000] px-4 py-3 text-white outline-none transition focus:border-[#E69A00]"
              ></textarea>{" "}
            </div>{" "}
            <button
              type="submit"
              className="mt-6 w-full rounded-lg bg-[#E69A00] px-6 py-3 font-bold text-[#240000] transition hover:scale-[1.02] hover:bg-[#f0a900]"
            >
              {" "}
              Send Message{" "}
            </button>{" "}
