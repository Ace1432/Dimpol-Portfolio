  ...
  return (
    <section id="about" className="section-padding min-h-screen bg-[#240000]">
      <div className="container-main flex min-h-screen items-center">
        <div
          ref={sectionRef}
          className="scroll-reveal grid w-full items-center gap-12 lg:grid-cols-2 lg:gap-20"
        >
          {/* Image */}
          <div className="scroll-reveal visible delay-100 flex justify-center lg:justify-center">
          ...
          {/* Content */}
          <div className="scroll-reveal visible delay-200 flex flex-col gap-6">
            {/* Section Label */}
            <div>
            ...
            <div className="mt-2 flex flex-wrap gap-3">
              <span className="rounded-full border border-[#E69A00]/40 px-5 py-2 text-sm text-[#E69A00] transition-colors duration-200 hover:bg-[#E69A00]/10 hover:border-[#E69A00]/60 cursor-default">
                IT Graduate
              </span>
